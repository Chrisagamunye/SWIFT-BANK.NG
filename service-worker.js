const CACHE_NAME="swiftbank-login-click-fixed-v3";
const FILES_TO_CACHE=["./","./index.html","./download.html","./style.css","./app.js","./firebase-config.js","./manifest.json","./assets/swiftbank-logo.svg","./icons/icon-192.png","./icons/icon-512.png"];
